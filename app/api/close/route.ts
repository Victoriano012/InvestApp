...
import { ensureHistory, FX_SYMBOL } from "@/lib/market";
 ...
 * → { price, currency, usdPerEur, unitValue }
 ...
 * that date (needed to size basket sells); `usdPerEur` converts entered EUR
 * amounts to USD-quoted assets and vice versa.
 */
